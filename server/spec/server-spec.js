...
describe('Persistent Node Chat Server', function() {
  ...
  it('Should output all messages from the DB', function(done) {
    ...
    var queryString = `INSERT INTO messages(ID, messageText, username, roomname) values(23423, "Men like you can never change!", "coolDudeWhoaMan", "main")`;
    var queryArgs = ['ID', 'messageText', 'username', 'roomname'];
